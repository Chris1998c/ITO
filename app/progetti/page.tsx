...
const categories: Category[] = [
  {
    ...
    items: [
      {
        id: 101,
        name: "CASA UNIFAMILIARE",
        price: "€200",
        media: [
          { type: "image", src: "/CASA-M.jpg" },
          { type: "image", src: "/CASA-1.jpg" },
          { type: "image", src: "/CASA-2.jpg" },
          { type: "image", src: "/CASA-3.jpg" },
          { type: "image", src: "/CASA-4.jpg" },
          { type: "image", src: "/CASA-5.jpg" },
          { type: "image", src: "/CASA-6.jpg" },
        ],
        description:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: "€1400",
        media: [
          { type: "image", src: "/POLTRONA-PELLE-M.jpg" },
          { type: "image", src: "/POLTRONA-PELLE-1.jpg" },
          { type: "image", src: "/POLTRONA-PELLE-2.jpg" },
          { type: "image", src: "/POLTRONA-PELLE-3.jpg" },
          { type: "image", src: "/POLTRONA-PELLE-4.jpg" },
          { type: "image", src: "/POLTRONA-PELLE-5.jpg" },
          { type: "image", src: "/POLTRONA-PELLE-6.jpg" },
        ],
        description: "Divano elegante e confortevole.",
      },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: "€1500",
        media: [
          { type: "image", src: "/TAVOLO-BAR-M.jpg" },
          { type: "image", src: "/TAVOLO-BAR-1.jpg" },
          { type: "image", src: "/TAVOLO-BAR-2.jpg" },
          { type: "image", src: "/TAVOLO-BAR-3.jpg" },
          { type: "image", src: "/TAVOLO-BAR-4.jpg" },
    ...
    items: [
      {
        ...
        price: "€1000",
        media: [
          { type: "image", src: "/BORSA-M.jpg" },
          { type: "image", src: "/BORSA-1.jpg" },
          { type: "image", src: "/BORSA-2.jpg" },
          { type: "image", src: "/BORSA-3.jpg" },
          { type: "image", src: "/BORSA-4.jpg" },
          { type: "image", src: "/BORSA-5.jpg" },
          { type: "image", src: "/BORSA-6.jpg" },
        ],
      ...
      },
      {
        ...
        price: "€1000",
        media: [
          { type: "image", src: "/TROLLEY-M.jpg" },
          { type: "image", src: "/TROLLEY-1.jpg" },
          { type: "image", src: "/TROLLEY-2.jpg" },
          { type: "image", src: "/TROLLEY-3.jpg" },
          { type: "image", src: "/TROLLEY-4.jpg" },
          { type: "image", src: "/TROLLEY-5.jpg" },
        ],
        description: "Valigia premium per viaggi eleganti.",
      },
    ],
    ...
    items: [
      {
        ...
        media: [
          ...
          { type: "video", src: "/LAMPADA-DA-TAVOLO-V.mp4" },
        ],
        description: "Lampada moderna per ambienti minimalisti.",
      },
      {
        id: 901,
        name: "Lampada Da Letto",
        price: "€400",
        media: [
          { type: "image", src: "/LAMPADA-DA-LETTO-M.jpg" },
          { type: "image", src: "/LAMPADA-DA-LETTO-1.jpg" },
          { type: "image", src: "/LAMPADA-DA-LETTO-2.jpg" },
          { type: "image", src: "/LAMPADA-DA-LETTO-3.jpg" },
          { type: "image", src: "/LAMPADA-DA-LETTO-4.jpg" },
          { type: "image", src: "/LAMPADA-DA-LETTO-5.jpg" },
          { type: "image", src: "/LAMPADA-DA-LETTO-6.jpg" },
          { type: "image", src: "/LAMPADA-DA-LETTO-7.jpg" },
          { type: "image", src: "/LAMPADA-DA-LETTO-8.jpg" },
        ],
        description: "Lampada moderna per ambienti minimalisti.",
      },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 1002,
        name: "PIATTO PORTAPOSATE",
        price: "€300",
        media: [
          { type: "image", src: "/PIATTO-M.jpg" },
          { type: "image", src: "/PIATTO-1.jpg" },
        ],
        description: "Set completo di piatti artigianali.",
      },
      {
        id: 1003,
        name: "PIATTO INSALATA",
        price: "€300",
        media: [
          { type: "image", src: "/PIATTO-INSALATA-M.jpg" },
          { type: "image", src: "/PIATTO-INSALATA-1.jpg" },
        ],
        description: "Set completo di piatti artigianali.",
      },
      {
        ...
        price: "€500",
        media: [
          { type: "image", src: "/POSATE-FILO-M.jpg" },
          { type: "image", src: "/POSATE-FILO-1.jpg" },
          { type: "image", src: "/POSATE-FILO-2.jpg" },
          { type: "image", src: "/POSATE-FILO-3.jpg" },
        ],
        description: "Set completo di piatti artigianali.",
      },
    ],
